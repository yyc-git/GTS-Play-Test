...
// import { data, api.getSizeFactor, api.multiplyScalar } from "../../../scene3d_layer/script/scene/scene_city/data/CollisionShapeData"
// import { collisionPart, pose } from "../../../scene3d_layer/script/scene/scene_city/type/StateType"
// import { state } from "../../../scene3d_layer/type/StateType"
// import { mmdCharacter } from "./MMDData"
...
// export let api.getSizeFactor = (state: state) => {
// 	let factor
...
// export let api.multiplyScalar = (size: size, scalar): size => {
...
export let getData = (
	...
	return [
		...
		{
			mmds: [
			// 	mmdCharacter.Meiko, mmdCharacter.Haku_QP, mmdCharacter.Haku_Lady,
			mmdCharacter.Baixi_Maid,
			// mmdCharacter.XiaHui,
			// mmdCharacter.Moye,
			// mmdCharacter.Miku1,
